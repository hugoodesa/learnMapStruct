    ...
    stages {
        ...
        stage('Tomcat deploy') {
            steps {
                ...
                deploy adapters: [tomcat9(credentialsId: 'tomcat', path: '', url: 'http://tomcat9:8082')], contextPath: '/var/jenkins_home/workspace/pipelineDev/target/', onFailure: false, war: 'learnMapStruct-0.0.1-SNAPSHOT.war'
            }
        }
